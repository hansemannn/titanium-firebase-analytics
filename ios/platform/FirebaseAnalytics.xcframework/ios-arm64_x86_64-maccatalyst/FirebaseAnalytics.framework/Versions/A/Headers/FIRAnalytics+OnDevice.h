...
/// Initiates on-device conversion measurement given a consented, user-provided email address.
...
/// Initiates on-device conversion measurement given a consented, user-provided phone number in
/// E.164 format. Requires dependency GoogleAdsOnDeviceConversion from
/// https://github.com/googleads/google-ads-on-device-conversion-ios-sdk/ to be linked in, otherwise
/// it is a no-op.
...
/// Initiates on-device conversion measurement given a sha256-hashed, consented, user-provided email
/// address. Requires dependency GoogleAdsOnDeviceConversion from
/// https://github.com/googleads/google-ads-on-device-conversion-ios-sdk/ to be linked in, otherwise
/// it is a no-op.
...
/// Initiates on-device conversion measurement given a sha256-hashed, consented, user-provided phone
/// number in E.164 format. Requires dependency GoogleAdsOnDeviceConversion from
/// https://github.com/googleads/google-ads-on-device-conversion-ios-sdk/ to be linked in, otherwise
/// it is a no-op.
